...
export class ProductServices {
  private produits: Produits[] = [
    ...
    {
      id: 2, nom: "Salade César", categorie: 'Entrée', prix: 12,
    ...
    {
      id: 3, nom: "Carpaccio de Bœuf", categorie: 'Entrée', prix: 14,
    ...
    {
      id: 4, nom: "Bruschetta Tomate", categorie: 'Entrée', prix: 9,
    ...
    {
      id: 5, nom: "Nems aux Crevettes", categorie: 'Entrée', prix: 10,
    ...
    {
      id: 6, nom: "Tartare de Saumon", categorie: 'Entrée', prix: 15,
    ...
    {
      id: 7, nom: "Camembert Rôti", categorie: 'Entrée', prix: 11,
    ...
    // --- PLATS ---
    {
      id: 8, nom: "Entrecôte Grillée", categorie: 'Plat', prix: 24,
    ...
    {
      id: 9, nom: "Risotto aux Champignons", categorie: 'Plat', prix: 18,
    ...
    {
      id: 10, nom: "Pavé de Cabillaud", categorie: 'Plat', prix: 21,
    ...
    {
      id: 13, nom: "Poulet Tikka Masala", categorie: 'Plat', prix: 19,
    ...
    {
      id: 14, nom: "Magret de Canard", categorie: 'Plat', prix: 26,
    ...
    {
      id: 15, nom: "Pâtes à la Carbonara", categorie: 'Plat', prix: 15,
    ...
    // --- DESSERTS ---
    {
      id: 16, nom: "Tiramisu Classique", categorie: 'Dessert', prix: 8,
    ...
    {
      id: 17, nom: "Fondant au Chocolat", categorie: 'Dessert', prix: 9,
    ...
    {
      id: 18, nom: "Crème Brûlée", categorie: 'Dessert', prix: 7,
    ...
    {
      id: 19, nom: "Tarte Tatin", categorie: 'Dessert', prix: 8,
    ...
    {
      id: 20, nom: "Salade de Fruits", categorie: 'Dessert', prix: 6,
    ...
    {
      id: 21, nom: "Mousse au Chocolat", categorie: 'Dessert', prix: 7,
    ...
    {
      id: 22, nom: "Cheesecake Citron", categorie: 'Dessert', prix: 9,
    ...
    // --- BOISSONS ---
    {
      id: 23, nom: "Limonade Maison", categorie: 'Boisson', prix: 5,
    ...
    {
      id: 27, nom: "Bière Artisanale", categorie: 'Boisson', prix: 6.5,
    ...
    {
      id: 28, nom: "Cocktail Mojito", categorie: 'Boisson', prix: 10,
      description: "Rhum, citron vert, menthe fraîche et soda.",
      image: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=400",
      details: ["Glacé", "Produits frais"]
    },
    {
      id: 29, nom: "Eau Minérale", categorie: 'Boisson', prix: 4,
    ...
    {
      id: 30, nom: "Jus d'Orange Frais", categorie: 'Boisson', prix: 6,
